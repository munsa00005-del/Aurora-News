...
export const CATEGORIES: CategoryConfig[] = [
  ...
  { slug: "ai", label: "AI", limit: 8, weight: 1.3, accent: "#A855F7", query: "artificial intelligence" },
  ...
  { slug: "crime", label: "Crime", limit: 8, weight: 0.9, accent: "#DC2626", query: "crime" },
