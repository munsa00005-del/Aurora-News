...
export function InfoPage({
  ...
  return (
    <section className="mx-auto max-w-4xl px-4 pb-20 pt-32 sm:px-6 sm:pt-40">
      <div className="mb-10">
        <span className="inline-flex rounded-full border border-border bg-white/60 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-muted">
          {eyebrow}
        </span>
      ...
      {showContact && (
        <div className="mt-10 rounded-lg border border-border bg-card p-5">
          ...
          <a
            href={`mailto:${CONTACT_EMAIL}`}
            className="mt-4 inline-flex items-center gap-2 rounded-full border border-border bg-white/60 px-4 py-2 text-sm font-medium text-muted transition hover:border-accent/35 hover:text-ink"
          >
